...
<body style="background-color: #fcfcfc;">
    ...
    <form id="form1" runat="server">
        ...
        <p>
          <b>กรณีต้องการไฟล์ข้อมูลลูกค้า สามารถแจ้งขอเปิดไฟล์ข้อมูลลูกค้า กับทาง BCS ได้ที่ E-Mail: </b> 
          <a href="mailto:support_bcs@jasmine.com?subject=ต้องการไฟล์ข้อมูลลูกค้า">support_bcs@jasmine.com</a>
        </p>

          <div style="display: flex;justify-content: center;align-items: center; font-size: 16px;">
            <br>โดยส่งข้อมูลประกอบการแจ้ง ดังนี้
            <br>1. Account
            <br>2. เลขที่เอกสารไฟล์ที่ต้องการเปิด
            <br>3. เหตุผลที่ต้องการเปิดไฟล์เอกสาร
          </div>
    </form>
    ...
    <p>
      <br><a href="openfile_old_excel.aspx">แบบฟอร์มขอเปิดไฟล์เอกสาร.xlsx</a>
