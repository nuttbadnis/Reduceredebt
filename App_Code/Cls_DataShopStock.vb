...
Public Class Cls_DataShopStock

    Private Function GetConnectionString() As String
        Dim strConn As String
        strConn = Configuration.WebConfigurationManager.ConnectionStrings("POS105ShopStockConnectionString").ConnectionString.ToString
        Return strConn
    End Function
...
#Region "DataTransaction"
    ...
    Public Function ExecuteNonQuery(ByVal QryStr As String, ByVal Transaction As Boolean) As Integer
        ...
        End If
    End Function
    Public Function ExecuteScalar(ByVal QryStr As String) As Integer
