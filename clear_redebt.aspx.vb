...
Partial Class clear_redebt
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ' If Array.IndexOf(CF.system_admin, Session("Uemail")) > -1 _
        ' Or CF.rCheckInDepart("", 10) = 1 Or CF.rCheckInDepart("", 20) = 1 _
        ' Or CF.rCheckInDepart("",30) = 1 Or CF.rCheckInDepart("",31) = 1 Or CF.rCheckInDepart("",32) = 1 Then 'สำหรับ ทีม support op
        If CF.rSpecialDepart(CF.system_admin) = 1 _
        Or CF.rSpecialDepart(CF.team_act_redebt) = 1 Or CF.rSpecialDepart(CF.team_bil_redebt) = 1 Or CF.rSpecialDepart(11) = 1 _
        Or CF.rSpecialDepart(30) = 1 Or CF.rSpecialDepart(31) = 1 Or CF.rSpecialDepart(32) = 1 Then 'สำหรับ ทีม cancle,tx,support op
        ...
        If Not Page.IsPostBack Then
            Me.Page.Title = "เคลียใบลดหนี้" + " [" + Me.Page.Title + "]"
        End If
