<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="new_ctshop30.aspx.vb" Inherits="new_ctshop30" %>
				...
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="form-group form-500">
							<label class="col-sm-2 control-label">รูปภาพพื้นที่เช่า</label>
							<div class="col-sm-10">
							...
							<div class="col-sm-10">
								<div class="form-inline">
									...
									<div id="div_ctphase_remark" class="input-group" style="display:none;padding-bottom: 17px;">
										...
										<input runat="server" type="text" class="form-control" maxlength="255" placeholder="1" id="txt_ctphase_remark" xd="txt_ctphase_remark" value="0">
...
<script type="text/javascript" src="App_Inc/_js/ctshop_form.js?v=40"></script>
