<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="update_redebt228.aspx.vb" Inherits="update_redebt228" %>
	...
	<div class="container">
		<div class="tab-content">
			...
			<div class="panel panel-default panel-space" runat="server" id="detail_form" xd="detail_form">
				...
				<div class="panel-body" runat="server" id="edit_form" xd="edit_form">
					<div class="form-horizontal">
						...
						<div class="panel panel-info">
							...
							<div class="form-group" id="div_redoc_claim" style="display: none;">
								<label class="col-sm-2 control-label"></label>
								<div class="col-sm-8 alert alert-danger" role="alert">
									<p>เลขที่ใบรับคืนดังต่อไปนี้ "จะไม่สามารถใช้แนบเพื่อคืนค่าประกันอุปกรณ์ได้ เนื่องจากเป็นใบรับคืนเพื่อเคลม" 
									<br>มีการเบิกอุปกรณ์ทดแทนให้ลูกค้า (สถานะอุปกรณ์อยู่ที่ลูกค้า)</p>
									<span id=txt_redoc_claim>
										<br>1. 
										<br>2. 
										<br>3. 
									</span>
						...
						<div class="panel panel-info">
							...
							<div class="space-br"></div>
							<div class="form-group form-500">
								<label class="col-sm-2 control-label">ผู้ลดหนี้ตามเขตพื้นที่</label>
								<div class="col-sm-10">
									<div class="form-inline">
										<div class="input-group approve-readonly">
											<input runat="server" type="text" id="txt_uemail_takecn" xd="txt_uemail_takecn" class="form-control input-sm input-addon-email" disabled>
											<div class="input-group-addon">@jasmine.com</div>
										</div>
										<input type="text" id="auto_takecn" class="form-control input-sm box-search approve-edit" style="display:none;" placeholder="ค้นหาอัตโนมัติโดย ชื่อ หรืออีเมล์">
										<input runat="server" id="hide_uemail_takecn" xd="hide_uemail_takecn" type="hidden">
										<span id="txt_desc_takecn" class="txt-desc-takecn txt-blue" style="margin-left:10px;"></span>
									</div>
								</div>
							</div>
							<div class="form-group form-500 required">
				...
				<div class="panel-body" runat="server" id="view_form">
					<div class="form-horizontal">
						...
						<div class="form-group txt-recommend refund3">
							<label class="col-sm-2 control-label">ธนาคาร:</label>
							<span id="inn_bank_title" class="col-sm-10 control-label left-label"></span>
						</div>
						<div class="form-group txt-recommend refund3">
							<label class="col-sm-2 control-label">รหัสสาขาธนาคาร:</label>
							<span runat="server" id="inn_fx01" class="col-sm-10 control-label left-label"></span>
						</div>
						<div class="form-group txt-recommend refund3">
							<label class="col-sm-2 control-label">เลขที่บัญชี:</label>
							<span runat="server" id="inn_fx02" class="col-sm-10 control-label left-label"></span>
						</div>
						<div class="form-group txt-recommend refund3">
							<label class="col-sm-2 control-label">ชื่อบัญชี:</label>
							<span runat="server" id="inn_mx03" class="col-sm-10 control-label left-label"></span>
						</div>
						<div class="space-br"></div>
						<div class="form-group">
							<label class="col-sm-2 control-label">ประเภทใบรับคืน:</label>
							<span id="inn_redoc_type" class="col-sm-10 control-label left-label"></span>
						</div>
						<div id="div_inn_redoc_account_to" style="display:none;">
							<div class="form-group">
								<label class="col-sm-2 control-label">ขอใบรับคืนต่าง Account:</label>
								<span runat="server" id="inn_redoc_account_number_to" class="col-sm-10 control-label left-label"></span>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label">ชื่อลูกค้า:</label>
								<span runat="server" id="inn_redoc_account_name_to" class="col-sm-10 control-label left-label"></span>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label">สาเหตุใบรับคืนต่าง Account:</label>
								<span runat="server" id="inn_redoc_remark" class="col-sm-10 control-label left-label"></span>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">เลขที่ใบรับคืนอุปกรณ์:</label>
							<div class="col-sm-10 control-label left-label label-padtop-inlinebtn">
								<span runat="server" id="inn_redoc_no_item" style="display: inline-block;width: 160px;"></span>
								<button class="btn btn-sm count-redoc-item-process" type="button" title="ประวัติใบรับคืน นับเฉพาะที่ยังไม่ปิดคำขอ">ยังไม่ปิดคำขอ <b class="badge">-</b></button>
								<button class="btn btn-sm count-redoc-item-close" type="button" title="ประวัติใบรับคืน นับเฉพาะที่ปิดคำขอแล้ว">ปิดคำขอแล้ว <b class="badge">-</b></button>
								<b id="status_reccm_ok" class="badge" title="ยืนยันความถูกต้อง"><span class="glyphicon icon-check"></span></b>
								<b id="status_reccm_qq" class="badge" title="รอการตรวจสอบเพิ่มเติม"><span class="glyphicon icon-question2"></span></b>
								<span id="doc_ref_qq" class="txt-gray" title="เลขที่อ้างอิง"></span>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">เลขที่ใบรับคืน Adapter:</label>
							<div class="col-sm-10 control-label left-label label-padtop-inlinebtn">
								<span runat="server" id="inn_redoc_no_adapter" style="display: inline-block;width: 160px;"></span>
								<button class="btn btn-sm count-redoc-adap-process" type="button" title="ประวัติใบรับคืน นับเฉพาะที่ยังไม่ปิดคำขอ">ยังไม่ปิดคำขอ <b class="badge">-</b></button>
								<button class="btn btn-sm count-redoc-adap-close" type="button" title="ประวัติใบรับคืน นับเฉพาะที่ปิดคำขอแล้ว">ปิดคำขอแล้ว <b class="badge">-</b></button>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">ผู้ลดหนี้ตามเขตพื้นที่ :</label>
							<div class="col-sm-10 control-label left-label">
								<span runat="server" id="inn_uemail_takecn" xd="inn_uemail_takecn"></span>
								<span class="txt-desc-takecn txt-blue" style="margin-left:10px;"></span>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">ผู้ตรวจสอบ 1:</label>
			...
			<div class="panel panel-default panel-space" runat="server" id="redebt_form">
				...
				<div class="panel-body" runat="server" id="edit_redebt" xd="edit_redebt">
					<div class="form-horizontal">
						<div class="form-group form-500 required-cn">
							...
							<div class="col-sm-10">
								<div class="form-inline">
									...
									<div class="input-group chk-group" id="div_kaysod" style="display:none;">
										<span class="input-group-addon">
											<input type="checkbox" id="chk_kaysod">
										</span>
										<span class="input-group-addon txt-bold">ลดหนี้ใบเสร็จขายสด</span>
									</div>
								</div>
							</div>
						</div>
						<div class="form-group form-500" id="div_redebt_file" style="display:none;">
							<label class="col-sm-2 control-label">ไฟล์ใบลดหนี้</label>
							<div class="col-sm-10">
								<div class="form-inline">
									<input name="redebt_file" id="redebt_file" type="file" class="form-control input-sm file-10mb" data-placement="bottom" data-content="อัพโหลดไฟล์ใบลดหนี้ <b class='txt-red'>**กรุณาเลือกไฟล์ให้ถูกต้อง ถ้าผิดจะไม่สามารถแก้ไขได้</b>" rel="pop_kaysod">
								</div>
							</div>
						</div>
						<div class="space-br"></div>
						<div class="form-group form-500">
							<div class="col-sm-offset-2 col-sm-10">
								<div class="form-inline">
									...
									<span class="txt-red">**กรุณาตรวจสอบ และเลือกใบลดหนี้ให้ถูกต้อง เพราะหากไม่ถูกต้อง จะไม่สามารถบันทึกเบิก E-Payment ได้</span>
								</div>
							</div>
						</div>
					</div>
...
<script type="text/javascript" src="App_Inc/_js/redebt_form.js?v=3888"></script>
...
<script type="text/javascript" src="App_Inc/_js/redebt_search_redoc.js?v=388"></script>
...
$(document).ready(function() { 
	...
	countRedocItemRQprocess($('input[xd="hide_redoc_no_item"]').val());
	countRedocAdapterRQprocess($('input[xd="hide_redoc_no_adapter"]').val());
