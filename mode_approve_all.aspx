<%@ Page Language="VB" AutoEventWireup="false" CodeFile="mode_approve_all.aspx.vb" Inherits="mode_approve_all" %>
...
<body>
	<form id="form1" runat="server">
		...
		<div id="stick_foot">
            ...
            <div id="sample_default" class="container sample-detail" style="display:none;">
                <div class="row">
                    <div class="col-xs-6">
                        <label class="txt-blue">เรื่องที่แจ้ง:</label>
                        <span id="def_request_title"></span>
                    </div>
                    <div class="col-xs-6">
                        <label class="txt-blue">วันที่เริ่มเปิดคำขอ:</label>
                        <span id="def_create_date"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <label class="txt-blue">หมายเหตุ:</label>
                        <span id="def_request_remark"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-6">
                        <label class="txt-blue">จังหวัดที่แจ้ง:</label>
                        <span id="def_province_name"></span>
                    </div>
                    <div class="col-xs-6">
                        <label class="txt-blue">ผู้สร้างคำขอ:</label>
                        <span id="def_create_by"></span>
                    </div>
                </div>
            </div>
			...
			<div id="sample_backof10" class="container sample-detail" style="display:none;">
                <div class="row">
                    <div class="col-xs-6">
                        <label class="txt-blue">เรื่องที่แจ้ง:</label>
                        <span id="b10_request_title"></span>
                    </div>
                    <div class="col-xs-6">
                        <label class="txt-blue">สาขาที่แจ้งปิด:</label>
                        <span id="b10_shop_name"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <label class="txt-blue">หมายเหตุแสดงบนเว็บ 3BB:</label>
                        <span id="b10_tx01"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <label class="txt-blue">คำอธิบายชี้แจงผู้อนุมัติ:</label>
                        <span id="b10_request_remark"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <label class="txt-blue">วันที่ขอปิดชั่วคราว:</label>
                        <span id="b10_mx01"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-6">
                        <label class="txt-blue">เขตพื้นที่:</label>
                        <span id="b10_province_name"></span>
                    </div>
                    <div class="col-xs-6">
                        <label class="txt-blue">ผู้สร้างคำขอ:</label>
                        <span id="b10_create_by"></span>
                    </div>
                </div>
            </div>

            <div id="sample_backof20" class="container sample-detail" style="display:none;">
                <div class="row">
                    <div class="col-xs-6">
                        <label class="txt-blue">เรื่องที่แจ้ง:</label>
                        <span id="b_request_title"></span>
                    </div>
                    <div class="col-xs-6">
                        <label class="txt-blue">สาขาที่แจ้ง:</label>
                        <span id="b_shop_name"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-6">
                        <label class="txt-blue">เขตพื้นที่:</label>
                        <span id="b_province_name"></span>
                    </div>
                    <div class="col-xs-6">
                        <label class="txt-blue">ผู้สร้างคำขอ:</label>
                        <span id="b_create_by"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
            ...
            <div id="sample_ctshop" class="container sample-detail" style="display:none;">
                <div class="row">
                    <div class="col-xs-6">
                        <label class="txt-blue">เรื่องที่แจ้ง:</label>
                        <span id="c_request_title"></span>
                    </div>
                                                                                <div class="col-xs-6">
                                                                                    <label class="txt-blue">อัตราการปรับค่าเช่า:</label>
                                                                                    <span id="c_ax04"></span>
                                                                                </div>
                </div>
                <div class="row">
                    <div class="col-xs-6">
                        <label class="txt-blue">สาขาที่แจ้ง:</label>
                        <span id="c_shop_name"></span>
                    </div>
                                                                                <div class="col-xs-6">
                                                                                    <label class="txt-blue">ค่าเช่ารวมค่าบริการ:</label>
                                                                                    <span id="c_ax07"></span>
                                                                                </div>
                </div>
                <div class="row">
                    <div class="col-xs-6">
                        ...
                        <span id="c_province_name"></span>
                    </div>
                                                                                <div class="col-xs-6">
                                                                                    <label class="txt-blue">ภาษีโรงเรือน:</label>
                                                                                    <span id="c_ax10"></span>
                                                                                </div>
                </div>
                <div class="row">
                    <div class="col-xs-6">
                        <label class="txt-blue">เขตพื้นที่:</label>
                        <span id="c_area_ro"></span>
                    </div>
                                                                                <div class="col-xs-6">
                                                                                    <label class="txt-blue">ค่าเบี้ยประกันวินาศภัย:</label>
                                                                                    <span id="c_ax09"></span>
                                                                                </div>
                </div>
                <div class="row">
                    <div class="col-xs-6">
                        <label class="txt-blue">ประเภทศูนย์บริการ:</label>
                        <span id="c_storeplacetype_name"></span>
                    </div>
                                                                                <div class="col-xs-6">
                                                                                    <label class="txt-blue">เงินประกันค่าเช่า:</label>
                                                                                    <span id="c_ax16"></span>
                                                                                </div>
                </div>
                <div class="row">
                    <div class="col-xs-6">
                        <label class="txt-blue">อายุสัญญา:</label>
                        <span id="c_phase_title"></span>
                    </div>
                                                                                <div class="col-xs-6">
                                                                                    <label class="txt-blue">เงินประกันค่าบริการ:</label>
                                                                                    <span id="c_ax17"></span>
                                                                                </div>
                </div>
                <div class="row">
                    <div class="col-xs-6">
                        <label class="txt-blue">ขนาดพื้นที่:</label>
                        <span id="c_ax19"></span>
                    </div>
                                                                                <div class="col-xs-6">
                                                                                    <label class="txt-blue">ค่าไฟฟ้า:</label>
                                                                                    <span id="c_ax13"></span>
                                                                                </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <label class="txt-blue">สถานที่ตั้งปัจจุบัน:</label>
                        <span id="c_tx01"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <label class="txt-blue">หมายเหตุ:</label>
                        <span id="c_request_remark"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-6">
                        <label class="txt-blue">ผู้สร้างคำขอ:</label>
                        <span id="c_create_by"></span>
                    </div>
                                                                                <div class="col-xs-6">
                                                                                    <label class="txt-blue">วันที่เริ่มเปิดคำขอ:</label>
                                                                                    <span id="c_create_date"></span>
                                                                                </div>
                </div>
            </div>
		</div>
