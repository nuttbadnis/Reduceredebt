<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="update_ctshop25.aspx.vb" Inherits="update_ctshop25" %>
				...
				<div class="panel-body" runat="server" id="view_form">
					<div class="form-horizontal">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">ค่าไฟฟ้า:</label>
							<div class="col-sm-10 control-label left-label">
								<span runat="server" id="inn_ax13"></span> <span runat="server" id="inn_elecharge_unit"></span> 
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">ค่าน้ำประปา:</label>
