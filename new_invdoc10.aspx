<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="new_invdoc10.aspx.vb" Inherits="new_invdoc10" %>
				...
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="panel panel-info">
							...
							<div class="space-br"></div>
							<div class="form-group form-500 required">
								<label class="col-sm-2 control-label">สำเนา ภ.พ.20<br/>และสำเนา Tax ID</label>
								<div class="col-sm-10">
									<input name="request_file3" id="request_file3" type="file" class="form-control input-sm file-10mb">
								</div>
							</div>
							<div class="form-group form-500 required">
								<label class="col-sm-2 control-label">รายงานอนุมัติ<br/>การจำหน่ายทรัพย์สิน/<br/>เศษซากจากคณะกรรมการ</label>
								<div class="col-sm-10">
									<div class="input-group col-md-5">
										<input name="request_file4" id="request_file4" type="file" class="form-control input-sm file-10mb">
										<span class="txt-red">*ต้องมีลายเซ็นต์จาก ประธานและคณะกรรมการให้ครบถ้วน</span>
									</div>
								</div>
							</div>
							<div class="form-group form-500 required">
								<label class="col-sm-2 control-label">TAG number/Asset Number</label>
								<div class="col-sm-10">
									<input name="request_file5" id="request_file5" type="file" class="form-control input-sm file-excel-10mb">
									<span class="txt-red">*ขอ (File Excel) ให้ระบุสินค้า รหัสทรัพย์สิน แยกราคาต่อสินค้า จำนวนสินค้า พร้อมแยกบริษัท TTTI และTTTBB</span>
								</div>
							</div>
							<div class="form-group form-500 required">
								<label class="col-sm-2 control-label">ใบส่งของ</label>
								<div class="col-sm-10">
									<input name="request_file6" id="request_file6" type="file" class="form-control input-sm file-10mb">
								</div>
							</div>
							<div class="form-group form-500">
								<label class="col-sm-2 control-label">ใบเสร็จรับเงินชั่วคราว (ถ้ามี)</label>
								<div class="col-sm-10">
									<input name="request_file7" id="request_file7" type="file" class="form-control input-sm file-10mb">
								</div>
							</div>
						<input name="request_file8" id="request_file8" type="file" class="form-control input-sm file-10mb" style="display:none;">
						<input name="request_file9" id="request_file9" type="file" class="form-control input-sm file-10mb" style="display:none;">
						<input name="request_file10" id="request_file10" type="file" class="form-control input-sm file-10mb" style="display:none;">
						</div>

						<!-- invdoc_form netVat by panu { -->
						<div class="space-br"></div>
						<div class="panel panel-info">
							<div class="panel-heading panel-fonting">
								<div class="form-inline">
									...
									<div class="form-group form-500">
										<div class="col-sm-offset-2 col-sm-10">
											<div class="form-inline">
												...
												<button type="button" class="btn btn-warning btn-sm" onclick="insertItemInvdoc_noncalculate();" id="btn_add_item">
													<span class="glyphicon icon-plus3" aria-hidden="true"></span> เพิ่มรายการ
												</button>
												<button type="button" class="btn btn-success btn-sm" onclick="insertItemInvdoc_noncalculate();" id="btn_update_item">
							...
							<!-- <div class="panel-body">
								...
								<div id="box_add_item" style="display: none;">
									...
									<div class="form-group form-500">
										...
										<div class="col-sm-10">
											<input type="text" id="txt_item_name" class="form-control input-sm" placeholder="ขายเศษซาก">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group" style="display: none;">
										<label class="col-sm-2 control-label">ราคาต่อหน่วย/Unit Price</label>
										<div class="col-sm-10">
											<div class="form-inline">
												<div class="input-group">
													<input type="text" id="txt_item_unit_price" class="form-control input-sm num-only" placeholder="9999999.99">
													<div class="input-group-addon addon-w0">บาท</div>
												</div>
											</div>
										</div>
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">จำนวนเงิน/Amount (รวม Vat)</label>
										<div class="col-sm-10">
											<div class="form-inline">
												<div class="input-group">
													<input type="text" id="txt_item_amount" class="form-control input-sm num-only" placeholder="9999.99">
...
<script type="text/javascript" src="App_Inc/_js/check_required.js?v=39"></script>
...
<script type="text/javascript">
	var invdoc_form = "netVat"; //(รวม Vat)
</script>
