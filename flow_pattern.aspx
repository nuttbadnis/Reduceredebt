<%@ Page Language="VB" AutoEventWireup="false" CodeFile="flow_pattern.aspx.vb" Inherits="flow_pattern" %>
...
<body>
	<form id="form1" runat="server" enctype="multipart/form-data">
		...
		<ol class="breadcrumb">
			<li class="active"><span class='glyphicon glyphicon-book'></span> Flow Pattern</li>
		</ol>
...
$(document).ready(function() {
	...
	var tabappend = "<li class='js-r'><a href='intro.aspx'><span class='glyphicon glyphicon-plus'></span> สร้างคำขอใหม่</a></li>";
