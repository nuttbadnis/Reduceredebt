<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="new_redebt25.aspx.vb" Inherits="new_redebt25" %>
			...
			<div class="panel panel-default panel-space">
				...
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="space-br"></div>
						<div class="form-group required refund1">
							<label class="col-sm-2 control-label">โยกยอดไปที่ Account</label>
							<div class="col-sm-10">
								<div class="form-inline">
									<input runat="server" id="hide_pick_refund" xd="hide_pick_refund" type="hidden" value="15">
						...
						<div class="form-group form-500 required refund1">
						...
						<div class="form-group form-500 required refund2" style="display:none;">
							...
							<div class="col-sm-10">
								<textarea runat="server" type="text" id="txt_tx01" xd="txt_tx01" class="form-control" rows="5" placeholder="โอนเข้าบัญชีธนาคาร/เช็ค..">null</textarea>
							</div>
						</div>
						<div class="space-br"></div>
						<div class="form-group form-500 required">
						...
						<div class="form-group form-500">
							<label class="col-sm-2 control-label">ไฟล์อีเมล์อนุมัติ</label>
							<div class="col-sm-10">
