<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="update_redebt28.aspx.vb" Inherits="update_redebt28" %>
			...
			<div class="panel panel-default panel-space" runat="server" id="detail_form" xd="detail_form">
				...
				<div class="panel-body" runat="server" id="edit_form" xd="edit_form">
					<div class="form-horizontal">
						...
						<div class="panel panel-info">
							...
							<div class="form-group form-500 refund3-disnone" style="display:none;">
							...
							<div class="form-group refund3-disnone" style="display:none;">
								<label class="col-sm-2 control-label"></label>
								<div class="col-sm-10">
				...
				<div class="panel-body" runat="server" id="view_form">
					<div class="form-horizontal">
						...
						<div class="form-group txt-recommend refund2" style="display:none;">
							<label class="col-sm-2 control-label label-pick-refund2" style="display:none;">ที่ Account:</label>
						...
						<div class="form-group txt-recommend refund1">
							<label class="col-sm-2 control-label">รายละเอียดการคืนเงิน:</label>
							<span runat="server" id="inn_tx01" class="col-sm-10 control-label left-label"></span>
						</div>
						<div class="form-group txt-recommend refund3" style="display:none;">
							<label class="col-sm-2 control-label">ธนาคาร:</label>
							<span id="inn_bank_title" class="col-sm-10 control-label left-label"></span>
						</div>
						<div class="form-group txt-recommend refund3-disnone" style="display:none;">
							<label class="col-sm-2 control-label">รหัสสาขาธนาคาร:</label>
...
$(document).ready(function() { 
	...
	if(checkSubjectForbidden() == false){
		$('#div_redebt_file').show();
	}

	if(checkSubjectForbidden() == true && $('input[xd="hide_redebt_number"]').val().trim().length == 0 && $('div[xd="edit_redebt"]').css('display') != "none"){
