<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="update_ctshop30.aspx.vb" Inherits="update_ctshop30" %>
			...
			<div class="panel panel-default panel-space" runat="server" id="detail_form" xd="detail_form">
				...
				<div class="panel-body" runat="server" id="edit_form" xd="edit_form">
					<div class="form-horizontal">
						...
						<div class="form-group form-500 required">
							<label class="col-sm-2 control-label">ตำแหน่งที่ตั้ง 3BB SHOP </label>
							<div class="col-sm-10">
						...
						<div class="form-group form-500">
							...
							<div class="col-sm-10">
								<div class="form-inline">
									...
									<input name="request_file7" id="request_file7" type="file" style="display:none;">
									<input name="request_file8" id="request_file8" type="file" style="display:none;">
									<input name="request_file9" id="request_file9" type="file" style="display:none;">
									<input name="request_file10" id="request_file10" type="file" style="display:none;">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">ค่าลากคู่สายโทรศัพท์</label>
							<div class="col-sm-10">
								<div class="input-group">
									<input runat="server" type="text" id="txt_ax15" xd="txt_ax15" class="form-control input-sm num-only input-addon-bath-2" placeholder="99.99">
							...
							<div class="col-sm-10">
								<div class="form-inline">
									<div class="input-group">
										...
										<div id="ea_ax13" class="input-group-addon addon-w0">(ยอดรวมภาษีมูลค่าเพิ่ม)</div>
									</div>
									<div class="input-group">
										<span class="input-group-addon">
						...
						<div class="form-group required">
							<label class="col-sm-2 control-label">เงินประกันค่าเช่า</label>
							<div class="col-sm-10">
								<div class="input-group">
									<input runat="server" type="text" id="txt_ax16" xd="txt_ax16" class="form-control input-sm num-only input-addon-bath-2" placeholder="99.99">
									<div class="input-group-addon addon-w0">บาท</div>
								</div>
							</div>
						</div>
						<div class="form-group required">
							<label class="col-sm-2 control-label">เงินประกันค่าบริการ</label>
							<div class="col-sm-10">
								<div class="input-group">
									<input runat="server" type="text" id="txt_ax17" xd="txt_ax17" class="form-control input-sm num-only input-addon-bath-2" placeholder="99.99">
									<div class="input-group-addon addon-w0">บาท (ยอดรวมภาษีมูลค่าเพิ่ม)</div>
								</div>
							</div>
						</div>
						...
						<div class="space-br"></div>
						<div class="form-group form-500">
							<label class="col-sm-2 control-label">เอกสารใบเสนอราคา<br>พื้นที่เช่าใหม่</label>
							<div class="col-sm-10">
								<div class="form-inline">
						...
						<div class="form-group form-500">
							<label class="col-sm-2 control-label">เอกสารเงื่อนไข<br>การทำสัญญาเช่าใหม่</label>
							<div class="col-sm-10">
								<div class="form-inline">
						...
						<div class="panel panel-info">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<div class="form-inline">
										<div class="input-group">
											<input runat="server" type="text" id="txt_ax01" xd="txt_ax01" class="form-control input-sm num-only input-addon-bath-2" placeholder="99.99" value="0">
											<div class="input-group-addon addon-w0">บาท</div>
										</div>
										<div class="input-group">
											<input runat="server" type="text" id="txt_nx01" xd="txt_nx01" class="form-control input-sm int-only input-addon-port" placeholder="99999" value="0">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<div class="form-inline">
										<div class="input-group">
											<input runat="server" type="text" id="txt_ax02" xd="txt_ax02" class="form-control input-sm num-only input-addon-bath-2" placeholder="99.99" value="0">
											<div class="input-group-addon addon-w0">บาท</div>
										</div>
										<div class="input-group">
											<input runat="server" type="text" id="txt_nx02" xd="txt_nx02" class="form-control input-sm int-only input-addon-port" placeholder="99999" value="0">
											<div class="input-group-addon addon-w0">port</div>
										</div>
									</div>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<div class="form-inline">
										<div class="input-group">
											<input runat="server" type="text" id="txt_ax03" xd="txt_ax03" class="form-control input-sm num-only input-addon-bath-2" placeholder="99.99" value="0">
											<div class="input-group-addon addon-w0">บาท</div>
										</div>
										<div class="input-group">
											<input runat="server" type="text" id="txt_nx03" xd="txt_nx03" class="form-control input-sm int-only input-addon-port" placeholder="99999" value="0">
											<div class="input-group-addon addon-w0">port</div>
										</div>
									</div>
								</div>
				...
				<div class="panel-body" runat="server" id="view_form">
					<div class="form-horizontal">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">ค่าลากคู่สายโทรศัพท์:</label>
							<span runat="server" id="inn_ax15" class="col-sm-10 control-label left-label"></span>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">ค่าเบี้ยประกันวินาศภัย:</label>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">ค่าไฟฟ้า:</label>
							<div class="col-sm-10 control-label left-label">
								<span runat="server" id="inn_ax13"></span>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">ค่าน้ำประปา:</label>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">เงินประกันค่าเช่า:</label>
							<span runat="server" id="inn_ax16" class="col-sm-10 control-label left-label"></span>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">เงินประกันค่าบริการ:</label>
							<span runat="server" id="inn_ax17" class="col-sm-10 control-label left-label"></span>
						</div>
						<%-- <div class="form-group">
							<label class="col-sm-2 control-label">เงินประกันการตกแต่ง:</label>
...
<script type="text/javascript" src="App_Inc/_js/ctshop_form.js?v=42"></script>
...
$(document).ready(function() { 
	...
	$('[id*=inn_ax15]').html(convertAmount($('[id*=inn_ax15]').html()) + " บาท (ยอดรวมภาษีมูลค่าเพิ่ม)");
	$('[id*=inn_ax16]').html(convertAmount($('[id*=inn_ax16]').html()) + " บาท");
	$('[id*=inn_ax17]').html(convertAmount($('[id*=inn_ax17]').html()) + " บาท (ยอดรวมภาษีมูลค่าเพิ่ม)");
