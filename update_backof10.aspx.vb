...
Partial Class update_backof10
    ...
    Sub Update_Submited()
        ...
        Dim request_remark As String = CP.rReplaceQuote(inn_request_remark.InnerHtml)
        Dim mx01 As String = CP.rReplaceQuote(inn_mx01.InnerHtml)
