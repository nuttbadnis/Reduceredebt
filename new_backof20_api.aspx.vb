...
Partial Class new_backof20_api
    ...
    Dim pageUrl As String = "backof20"
    Dim pageSubject_id As String = 911002
    ...
    Sub Submit_ShopStock()
        ...
        Dim request_title_id As String = "60"
        Dim request_title As String = "ขออนุมัติเปลี่ยนแปลงเวลาทำการสำนักงาน"
        ...
        Dim uemail_verify2 As String = CP.rReplaceQuote(Request.Form("uemail_verify2"))
        Dim uemail_approve As String = CP.rReplaceQuote(Request.Form("uemail_approve"))
