<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="update_invdoc30.aspx.vb" Inherits="update_invdoc30" %>
				...
				<div class="panel-body" runat="server" id="edit_form" xd="edit_form">
					<div class="form-horizontal">
						...
						<div class="panel panel-info">
							...
							<div class="space-br"></div>
							<div class="form-group form-500">
								<label class="col-sm-2 control-label">เอกสาร (TTTBB AP Voucher ) หน้า RP</label>
								<div class="col-sm-10">
									<div class="form-inline">	
							...
							<div class="form-group form-500">
								<label class="col-sm-2 control-label">ใบค้างส่งวัสดุสินค้า</label>
								<div class="col-sm-10">
									<div class="form-inline">	
							...
							<div class="form-group form-500">
								<label class="col-sm-2 control-label">ใบปิดงาน</label>
								<div class="col-sm-10">
									<div class="form-inline">	
										...
										<input name="request_file7" id="request_file7" type="file" style="display:none;" class="form-control input-sm file-10mb">
										<input name="request_file8" id="request_file8" type="file" style="display:none;" class="form-control input-sm file-10mb">
				...
				<div class="panel-body" runat="server" id="view_form">
					<div class="form-horizontal">
						...
						<div class="space-br"></div>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label">สำเนา ภ.พ.20และสำเนา Tax ID</label>
