<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="update_redebt10.aspx.vb" Inherits="update_redebt10" %>
				...
				<div class="panel-body" runat="server" id="edit_form" xd="edit_form">
					<div class="form-horizontal">
						...
						<div class="panel panel-info">
							...
							<div class="form-group form-500 required">
								<label class="col-sm-2 control-label">วันที่ชำระผิด</label>
								<div class="col-sm-10">
						...
						<div class="form-group required">
							<label class="col-sm-2 control-label">ออกใบเสร็จใหม่ที่ Account</label>
							<div class="col-sm-10">
								<div class="form-inline">
				...
				<div class="panel-body" runat="server" id="view_form">
					<div class="form-horizontal">
						...
						<div class="form-group txt-recommend">
							<label class="col-sm-2 control-label label-pick-refund2">ออกใบเสร็จใหม่ที่ที่ Account:</label>
