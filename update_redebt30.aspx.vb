...
Partial Class update_redebt30
    Inherits System.Web.UI.Page
    Dim DB105 As New Cls_Data105
    Dim CP As New Cls_Panu
    Dim CF As New Cls_RequestFlow

    Dim pageUrl As String = "redebt30"
    ...
    Sub loadDetail(ByVal vRequest_id As String)
        ...
        If(vDT.Rows().Count() > 0)
            ...
            'inn_mx02.InnerHtml = vDT.Rows(0).Item("mx02") 'ใบเสร็จออกจากช่องทาง ***แก้ไข 20190313 ไม่ต้องกรอกแล้ว
    ...
    Sub Update_Submited()
        ...
        Dim mx02 As String = ""'CP.rReplaceQuote(txt_mx02.Value) 'ใบเสร็จออกจากช่องทาง ***แก้ไข 20190313 ไม่ต้องกรอกแล้ว
