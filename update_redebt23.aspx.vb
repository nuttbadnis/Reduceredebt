...
Partial Class update_redebt23
    Inherits System.Web.UI.Page
    Dim DB105 As New Cls_Data105
    Dim CP As New Cls_Panu
    Dim CF As New Cls_RequestFlow

    Dim pageUrl As String = "redebt23"
    ...
    Sub loadDetail(ByVal vRequest_id As String)
        ...
        If(vDT.Rows().Count() > 0)
            ...
            'hide_uemail_takecn.Value() = vDT.Rows(0).Item("uemail_takecn")
            ...
            hide_redoc_value.Value() = vDT.Rows(0).Item("gx04") 
            hide_company_code.Value() = vDT.Rows(0).Item("ax01")
            ...
            'txt_uemail_takecn.Value() = vDT.Rows(0).Item("uemail_takecn")
            ...
            'inn_uemail_takecn.InnerHtml = vDT.Rows(0).Item("uemail_takecn") + "@jasmine.com"
    ...
    Sub Update_Submited()
        ...
        Dim uemail_takecn As String = ""'CP.rReplaceQuote(hide_uemail_takecn.Value)
        ...
        Dim gx04 As String = CP.rReplaceQuote(hide_redoc_value.Value)
        Dim ax01 As String = CP.rReplaceQuote(hide_company_code.Value)
        ' ข้อมูลใบรับคืนอุปกรณ์และ ใบรับคืน Adapter

        CF.UpdateRequest8CN(vRequest_id _
            , uemail_cc1, uemail_cc2, "", update_by _
            , create_by, create_ro _
            , create_shop, pick_refund _
            , uemail_verify1, uemail_verify2, uemail_approve, uemail_takecn _
    ...
    Sub loadRedebt(ByVal vRequest_id As String)
        If CF.rCheckInDepart(vRequest_id,10) = 1 Or CF.rCheckInDepart(vRequest_id,20) = 1 _
        Or (CF.rCheckInDepart(vRequest_id,1008) And CF.rCheckIsTakeCN(vRequest_id) = 1) Then
