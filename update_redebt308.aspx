<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="update_redebt308.aspx.vb" Inherits="update_redebt308" %>
				...
				<div class="panel-body" runat="server" id="edit_form" xd="edit_form">
					<div class="form-horizontal">
						...
						<div class="form-group form-500" style="display:none;">
							...
							<div class="col-sm-10">
								<input runat="server" type="text" id="txt_mx02" xd="txt_mx02" class="form-control input-sm" maxlength="50" placeholder="ระบุช่องทาง / APO">
							</div>
						</div>
						<div class="form-group form-500" style="display:none;">
