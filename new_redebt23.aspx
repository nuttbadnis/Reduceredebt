<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="new_redebt23.aspx.vb" Inherits="new_redebt23" %>
					...
					<div class="form-horizontal">
						...
						<div class="panel panel-info">
							...
							<%-- <div class="form-group required">
								...
								<div class="col-sm-10">
									<div class="form-inline">
										<input type="text" id="auto_takecn" class="form-control input-sm box-search" placeholder="ค้นหาอัตโนมัติโดย ชื่อ หรืออีเมล์">
										<input runat="server" id="hide_uemail_takecn" xd="hide_uemail_takecn" type="hidden">
										<span id="txt_desc_takecn" class="txt-blue" style="margin-left:10px;"></span>
									</div>
								</div>
							</div> --%>
							<div class="form-group required">
