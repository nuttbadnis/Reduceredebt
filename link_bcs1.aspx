<%@ Page Language="VB" AutoEventWireup="false" CodeFile="link_bcs1.aspx.vb" Inherits="link_bcs1" %>
	...
	<div class="container">
		<div class="panel panel-default">
			<div class="panel-heading">
				ดำเนินการบันทึกคำขอ <b>คืนเงินค่าประกัน ADSL เป็นค่าบริการรายเดือน</b> ตามขั้นตอนดังนี้
			...
			<div class="panel-body">
				<blockquote>
					<div class="form-inline">
						...
						<!-- <span id="span1">https://posbcs.triplet.co.th/FollowRequest/new_redebt25.aspx?subject_id=1002501</span> -->
					</div>
				</blockquote>
				<blockquote>
				...
				<blockquote>
					...
					<img src="App_Inc/_img/linkbcs1.png">
				</blockquote>
			</div>
		</div>
	</div>
