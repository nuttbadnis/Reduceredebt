...
Partial Class update_ctshop50
    ...
    Sub loadDetail(ByVal vRequest_id As String)
        ...
        If(vDT.Rows().Count() > 0)
            ...
            If vDT.Rows(0).Item("request_file9").Trim() <> "" Then
                request_file9 = CF.rLinkOpenfile(vRequest_id, vDT.Rows(0).Item("path_file9"), vDT.Rows(0).Item("request_file9"))
            End If
            If vDT.Rows(0).Item("request_file10").Trim() <> "" Then
                request_file10 = CF.rLinkOpenfile(vRequest_id, vDT.Rows(0).Item("path_file10"), vDT.Rows(0).Item("request_file10"))
            End If
            If vDT.Rows(0).Item("request_file11").Trim() <> "" Then
                request_file11 = CF.rLinkOpenfile(vRequest_id, vDT.Rows(0).Item("path_file11"), vDT.Rows(0).Item("request_file11"))
            End If
            If vDT.Rows(0).Item("request_file12").Trim() <> "" Then
                request_file12 = CF.rLinkOpenfile(vRequest_id, vDT.Rows(0).Item("path_file12"), vDT.Rows(0).Item("request_file12"))
            End If
            ...
            txt_ax18.Value() = vDT.Rows(0).Item("ax18") 
            ...
            inn_ax18.InnerHtml = vDT.Rows(0).Item("ax18") 
            ...
            inn_request_file9.InnerHtml = request_file9
            inn_request_file10.InnerHtml = request_file10
            inn_request_file11.InnerHtml = request_file11          
            'inn_request_file12.InnerHtml = " [ " + request_file12 + " ] "
    ...
    Sub loadFlow(ByVal vRequest_id As String, ByVal vRequest_status As String, ByVal vRequest_step As String)
        ...
        Else If vRequest_permiss = 0 Then
            ...
            inn_request_file9.InnerHtml = CF.file_dont_request_permiss
            inn_request_file10.InnerHtml = CF.file_dont_request_permiss
            inn_request_file11.InnerHtml = CF.file_dont_request_permiss          
            'inn_request_file12.InnerHtml = CF.file_dont_request_permiss
    ...
    Sub SendMail_Submit(ByVal Source As Object, ByVal E As EventArgs)
        Dim vRequest_id As String = "C5022020001"
        Dim vAlert_Mss As String = "ส่งอีเมล์แจ้ง มีการแก้ไขข้อมูลคำขอ"
        CF.sendMailAndRedirect("Reply_2", vRequest_id, vAlert_Mss)
    End Sub
    ...
    Sub Update_Submited()
        ...
        Dim sx01 As String = 0'CP.rReplaceQuote(sel_placetype.selectedValue)
