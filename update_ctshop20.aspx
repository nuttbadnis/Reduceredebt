<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="update_ctshop20.aspx.vb" Inherits="update_ctshop20" %>
			...
			<div class="panel panel-default panel-space" runat="server" id="detail_form" xd="detail_form">
				...
				<div class="panel-body" runat="server" id="edit_form" xd="edit_form">
					<div class="form-horizontal">
						...
						<div class="space-br"></div>
						<div class="form-group form-500 required">
							<label class="col-sm-2 control-label">ประเภทพื้นที่</label>
							<div class="col-sm-10">
								<asp:DropDownList runat="server" id="sel_placetype" xd="sel_placetype" class="form-control input-sm"></asp:DropDownList>
							</div>
						</div>
						<div class="form-group form-500 required">
							<label class="col-sm-2 control-label">สถานที่ตั้งปัจจุบัน</label>
							<div class="col-sm-10">
						...
						<div class="form-group form-500">
							<label class="col-sm-2 control-label">รูป 3BB SHOP ปัจจุบัน</label>
							<div class="col-sm-10">
								<div class="form-inline">
						...
						<div class="form-group required">
							...
							<div class="col-sm-10">
								<div class="form-inline">
									...
									<div id="div_ctphase_remark" class="input-group" style="padding-bottom: 17px;">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="input-group">
									<input runat="server" type="text" id="txt_gx01" xd="txt_gx01" class="form-control input-sm num-only input-addon-bath-ea" placeholder="99.99" readonly>
									<div class="input-group-addon addon-w0">บาท (ยอดรวมภาษีมูลค่าเพิ่ม)</div>
								</div>
							</div>
						</div>
...
<script type="text/javascript" src="App_Inc/_js/ctshop_form_tam.js?v=39"></script>
