...
Partial Class new_rqshop10
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ' vDT = CP.userDepartmentTB("naruchol.m")
            ' hide_depart_id.Value() = vDT.Rows(0).Item("depart_id")
    ...
    Sub Submit_ShopStock(ByVal Source As Object, ByVal E As EventArgs)
        ...
        Dim mx03 As String = 0'CP.rReplaceQuote(txt_decoration_fee.Value)
        ...
        ' Page.ClientScript.RegisterStartupScript(Me.GetType(), "alertscript", "console.log('fx01 : "+fx01+", ax01 : "+ax01+"');", True)
        CF.InsertRequest( _
