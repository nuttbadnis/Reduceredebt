...
Partial Class new_redebt21
    ...
    Dim pageUrl As String = "redebt21"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Or CF.rSpecialDepart(CF.team_act_redebt) = 1 _
        Or CF.rSpecialDepart(CF.team_bil_redebt) = 1 _
        Or CF.rSpecialDepart(CF.team_cre_80) = 1 _
        Then
