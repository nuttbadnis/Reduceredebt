...
Partial Class update_ctshop30
    ...
    Dim pageUrl As String = "ctshop30"
    ...
    Sub loadDetail(ByVal vRequest_id As String)
        ...
        If(vDT.Rows().Count() > 0)
            ...
            txt_ax15.Value() = vDT.Rows(0).Item("ax15") 
            txt_ax16.Value() = vDT.Rows(0).Item("ax16") 
            txt_ax17.Value() = vDT.Rows(0).Item("ax17") 
            ...
            DBShopStock.SetDropDownList(sel_placetype, vSql, "storeplacetype_name", "storeplacetype_id", "เลือกประเภทศูนย์บริการ")
            ...
            inn_ax15.InnerHtml = vDT.Rows(0).Item("ax15") 
            inn_ax16.InnerHtml = vDT.Rows(0).Item("ax16") 
            inn_ax17.InnerHtml = vDT.Rows(0).Item("ax17") 
