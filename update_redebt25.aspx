<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="update_redebt25.aspx.vb" Inherits="update_redebt25" %>
                ...
                <div class="panel-body" runat="server" id="view_form">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group txt-recommend">
                            <label class="col-sm-2 control-label label-pick-refund2">โยกยอดไปที่ Account:</label>
