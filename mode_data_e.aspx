<%@ Page Language="VB" AutoEventWireup="false" CodeFile="mode_data_e.aspx.vb" Inherits="mode_data_e" %>
...
<body>
	...
	,"<li id='3'><span class='glyphicon glyphicon-sort'></span><input type='checkbox' class='disorplay' id='chk_3' value='3' checked> จังหวัดที่แจ้ง</li>"
	,"<li id='4'><span class='glyphicon glyphicon-sort'></span><input type='checkbox' class='disorplay' id='chk_4' value='4' checked> RO ที่แจ้ง</li>"
	...
	"<li id='0' style='display:none;'><input type='checkbox' class='disorplay' id='chk_0' value='0' checked></li>"
	,"<li id='1'><span class='glyphicon glyphicon-sort'></span><input type='checkbox' class='disorplay' id='chk_1' value='1' checked> เลขที่คำขอ</li>"
	,"<li id='2'><span class='glyphicon glyphicon-sort'></span><input type='checkbox' class='disorplay' id='chk_2' value='2' checked> เลขที่เอกสาร</li>"
	,"<li id='3'><span class='glyphicon glyphicon-sort'></span><input type='checkbox' class='disorplay' id='chk_3' value='3' checked> หัวข้อ</li>"
	,"<li id='4'><span class='glyphicon glyphicon-sort'></span><input type='checkbox' class='disorplay' id='chk_4' value='4' checked> จังหวัดที่แจ้ง</li>"
	,"<li id='5'><span class='glyphicon glyphicon-sort'></span><input type='checkbox' class='disorplay' id='chk_5' value='5' checked> RO ที่แจ้ง</li>"
		...
		$.ajax({
			...
			success: function( data ) { 
				...
				$.each(data,function( i,item ) {
					...
					txt_html += "<td>" + item.invdoc_runid + "</td>"
					txt_html += "<td>" + limitStr(item.subject_prefix + ". " + item.subject_name,40) + "</td>"
					// txt_html += "<td>" + limitStr(item.fx01 + ": " + item.shop_name,40) + "</td>"
					txt_html += "<td>" + itemNull(item.prov_short) + "</td>"
    ...
    <script type="text/javascript" src="App_Inc/_js/page_default.js?v=38"></script>
