<%@ Page Language="VB" AutoEventWireup="false" CodeFile="mode_approve_c.aspx.vb" Inherits="mode_approve_c" %>
        ...
        $.ajax({
            ...
            success: function( data ) { 
                ...
                $.each(data,function( i,item ) {
                    ...
                    txt_html += "<td class='td-center'>RO" + itemNull(item.area_ro) + "</td>"
                    txt_html += "<td class='td-center'>" + itemNull(item.fx02) + "</td>"
                    txt_html += "<td>" + itemShop(item.fx01, item.shop_name, 35) + "</td>"
