<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="new_ctshop25.aspx.vb" Inherits="new_ctshop25" %>
				...
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="form-group form-500 required">
							...
							<div class="col-sm-10">
								<div class="input-group">
									...
									<div class="input-group-addon addon-w0">บาท/เดือน (ไม่มี VAT)</div>
								</div>
							</div>
						</div>
						<div class="form-group form-500 required">
							...
							<div class="col-sm-10">
								<div class="input-group">
									...
									<div class="input-group-addon addon-w0">บาท/เดือน (รวม VAT)</div>
								</div>
							</div>
						</div>
						<div class="form-group form-500">
						...
						<div class="form-group required">
							...
							<div class="col-sm-10">
								<div class="input-group">
									<input runat="server" type="text" id="txt_ax07" xd="txt_ax07" class="form-control input-sm num-only input-addon-bath-nvat" placeholder="99999.99">
									<div class="input-group-addon addon-w0">บาท/เดือน (รวม VAT)</div>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="input-group">
									...
									<div class="input-group-addon addon-w0">บาท/เดือน</div>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="form-inline">
									<div class="input-group">
										...
										<div id="ea_ax13" class="input-group-addon addon-w0">บาท/หน่วย</div>
									</div>
									<div class="input-group">
										<span class="input-group-addon">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="input-group">
									...
									<div class="input-group-addon addon-w0">บาท/หน่วย</div>
								</div>
							</div>
						</div>
							...
							<div class="col-sm-10">
								<div class="form-inline">
									...
									<div id="div_ctphase_remark" class="input-group" style="display:none;padding-bottom: 17px;">
										...
										<input runat="server" type="text" class="form-control" maxlength="255" placeholder="1 เดือนครึ่ง" id="txt_ctphase_remark" value="0">
									</div>
								</div>
							</div>
						</div>
