<%@ Page Language="VB" AutoEventWireup="false" CodeFile="mode_approve.aspx.vb" Inherits="mode_approve" %>
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">คุณต้องการใช้ Mode Approve เป็นหน้าหลักเสมอ</h4>
				</div>
