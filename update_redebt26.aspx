<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="update_redebt26.aspx.vb" Inherits="update_redebt26" %>
                ...
                <div class="panel-body" runat="server" id="edit_form" xd="edit_form">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group form-500 required">
                            ...
                            <div class="col-sm-10">
                                <select runat="server" id="sel_cause" xd="sel_cause" class="form-control input-sm">
						...
						<div class="form-group form-500 required refund2">
							<label class="col-sm-2 control-label">ลูกค้าต้องการคืนเงินเป็น</label>
							<div class="col-sm-10">
                                <input runat="server" id="hide_pick_refund" xd="hide_pick_refund" type="hidden">
								<textarea runat="server" type="text" id="txt_tx01" xd="txt_tx01" class="form-control" rows="1" disabled>ลูกค้ายินดีไม่รับค่าประกันอุปกรณ์คืน</textarea>
							</div>
						</div>
                        <div class="space-br"></div>
                        <div class="form-group form-500 required">
                        ...
                        <div class="form-group form-500">
                            <label class="col-sm-2 control-label">หนังสือยินยอมหักค่าประกันอุปกรณ์</label>
                            <div class="col-sm-10">
                                <div class="form-inline">
                        ...
                        <div class="panel panel-info">
                            ...
                            <div runat="server" id="form_cc1" class="form-group form-500 form-cc1" style="display:none;">
                            ...
                            <div runat="server" id="form_cc2" class="form-group form-500 form-cc2" style="display:none;">
