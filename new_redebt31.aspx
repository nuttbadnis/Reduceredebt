<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="new_redebt31.aspx.vb" Inherits="new_redebt31" %>
				...
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="form-group form-500 required refund2">
							...
							<div class="col-sm-10">
								<input runat="server" id="hide_pick_refund" xd="hide_pick_refund" type="hidden" value="30">
