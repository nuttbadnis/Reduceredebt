...
Partial Class update_rqshop10
    ...
    Dim pageUrl As String = "rqshop10"
    ...
    Sub loadDetail(ByVal vRequest_id As String)
        ...
        If(vDT.Rows().Count() > 0)
            ...
            If vDT.Rows(0).Item("request_file13").Trim() <> "" Then
                request_file13 = CF.rLinkOpenfile(vRequest_id, vDT.Rows(0).Item("path_file13"), vDT.Rows(0).Item("request_file13"))
            End If
            If vDT.Rows(0).Item("request_file14").Trim() <> ""  Then
                request_file14 = CF.rLinkOpenfile(vRequest_id, vDT.Rows(0).Item("path_file14"), vDT.Rows(0).Item("request_file14"))
            End If
            If vDT.Rows(0).Item("request_file15").Trim() <> "" Then
                request_file15 = CF.rLinkOpenfile(vRequest_id, vDT.Rows(0).Item("path_file15"), vDT.Rows(0).Item("request_file15"))
            End If
            If vDT.Rows(0).Item("request_file16").Trim() <> "" Then
                request_file16 = CF.rLinkOpenfile(vRequest_id, vDT.Rows(0).Item("path_file16"), vDT.Rows(0).Item("request_file16"))
            End If
            If vDT.Rows(0).Item("request_file17").Trim() <> "" Then
                request_file17 = CF.rLinkOpenfile(vRequest_id, vDT.Rows(0).Item("path_file17"), vDT.Rows(0).Item("request_file17"))
            End If
