<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="update_redebt23.aspx.vb" Inherits="update_redebt23" %>
...
<form id="form1" runat="server" enctype="multipart/form-data">
	...
	<input runat="server" id="hide_company_code" xd="hide_company_code" type="hidden">
	<ol class="breadcrumb">
		<li>อัพเดทคำขอ</li>
					...
					<div class="form-horizontal">
						...
						<div class="panel panel-info">
							...
							<div class="container-fluid">
								<table id="table_redoc_item" class="table table-bordered table-sm">
								</table>
								<input runat="server" id="hide_redoc_value" xd="hide_redoc_value" type="hidden">
							</div>
							<div class="space-br"></div>
							<div class="form-group form-500" style="display: none;">
...
<script type="text/javascript" src="App_Inc/_js/redebt_search_autoinput.js?v=39"></script>
...
$(document).ready(function() { 
	...
	loadPickRefund();
	loadCheckEditRefund();
	checkCompanyReceipt($('input[xd="hide_company_code"]').val(), $('input[xd="txt_doc_number"]').val());
