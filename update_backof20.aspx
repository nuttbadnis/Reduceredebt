<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="update_backof20.aspx.vb" Inherits="update_backof20" %>
		...
		<div class="tab-content">
				...
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="form-group txt-recommend">
							<label class="col-sm-2 control-label">เวลาทำการใหม่:</label>
							<span runat="server" id="inn_tx01" class="col-sm-10 control-label left-label"></span>
						</div>
						<div class="space-br"></div>
						<div class="form-group">
							<label class="col-sm-2 control-label">เวลาทำการเดิม:</label>
			...
			<div class="panel panel-default panel-gray">
				...
				<div class="panel-body">
					...
					<b class="txt-red">**เมื่อปิดคำขอ ระบบจะอัพเดท "ข้อมูลเวลาเปิด-ปิด สำนักงาน" ที่ระบบ <a href="https://posbcs.triplet.co.th/3bbShop/admin_approval.aspx" target="_blank">3BB Shop Back Office</a> ให้อัตโนมัติ เพื่อให้ Back Office Admin อนุมัติข้อมูลขึ้นหน้าเว็บ 3BB Shop ต่อไป</b>
				</div>
			</div>
		</div>
	</div>
