<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="update_invdoc10.aspx.vb" Inherits="update_invdoc10" %>
				...
				<div class="panel-body" runat="server" id="edit_form" xd="edit_form">
					<div class="form-horizontal">
						...
						<div class="panel panel-info">
							...
							<div class="space-br"></div>
							<div class="form-group form-500">
								<label class="col-sm-2 control-label">ภ.พ20 ชื่อที่อยู่และเลขที่ผู้เสียภาษี/บัตรประชาชน</label>
								<div class="col-sm-10">
									<div class="form-inline">	
							...
							<div class="form-group form-500">
								<label class="col-sm-2 control-label">ใบสรุปการขายเศษซากจาก RO </label>
								<div class="col-sm-10">
									<div class="form-inline">	
							...
							<div class="form-group form-500">
								...
								<div class="col-sm-10">
									...
									<span class="txt-red">*ขอ (filexcel) ให้ระบุสินค้า รหัสทรัพย์สิน แยกราคาต่อสินค้า จำนวนสินค้า พร้อมแยกบริษัท TTTI และTTTBB</span>
								</div>
							</div>
							<div class="form-group form-500">
				...
				<div class="panel-body" runat="server" id="view_form">
					<div class="form-horizontal">
						...
						<div class="space-br"></div>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label">ใบสรุปการขาย<br/>เศษซากจาก RO </label>
