...
Partial Class mode_approve
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If CP.checkDepartApprove() > 0 Then
            If CP.checkSettingModeApprove() = 0 Then
                vThisMode = 0
    ...
    Sub Setting_Mode(ByVal Source As Object, ByVal E As EventArgs)
        ...
        vSqlIn += "insert into setting_mode (uemail, mode_approve) values ('" & Session("Uemail") & "', 1) "
    ...
    Sub gotoTabPin()
        ...
        If vTab <> "" Then
            vRedirect = vRedirect.Replace("mode_approve.aspx", "mode_approve_" & vTab & ".aspx")
        Else
            vRedirect = vRedirect.Replace("mode_approve.aspx", "mode_approve_all.aspx")
        End If
