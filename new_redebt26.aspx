<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="new_redebt26.aspx.vb" Inherits="new_redebt26" %>
				...
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="form-group form-500 required refund2">
							...
							<div class="col-sm-10">
								<input runat="server" id="hide_pick_refund" xd="hide_pick_refund" type="hidden" value="20">
								<textarea runat="server" type="text" id="txt_tx01" xd="txt_tx01" class="form-control" rows="1" readonly>ลูกค้ายินดีไม่รับค่าประกันอุปกรณ์คืน</textarea>
							</div>
						</div>
						<div class="space-br"></div>
						<div class="form-group form-500 required">
