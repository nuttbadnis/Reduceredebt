<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="update_backof10.aspx.vb" Inherits="update_backof10" %>
		...
		<div class="tab-content">
			...
			<div class="panel panel-default panel-gray">
				...
				<div class="panel-body">
					...
					<b class="txt-red">**เมื่อปิดคำขอ ระบบจะอัพเดท "หมายเหตุพิเศษ/ปิดศูนย์ชั่วคราว" ที่ระบบ <a href="https://posbcs.triplet.co.th/3bbShop/admin_approval.aspx" target="_blank">3BB Shop Back Office</a> ให้อัตโนมัติ เพื่อให้ Back Office Admin อนุมัติข้อมูลขึ้นหน้าเว็บ 3BB Shop ต่อไป</b>
				</div>
			</div>
		</div>
	</div>
