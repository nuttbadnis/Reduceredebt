<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="new_ctshop20.aspx.vb" Inherits="new_ctshop20" %>
						...
						<div class="form-group required">
							...
							<div class="col-sm-10">
								<div class="form-inline">
									...
									<div id="div_ctphase_remark" class="input-group" style="padding-bottom: 17px;display:none;">
...
<script type="text/javascript" src="App_Inc/_js/ctshop_request_new.js?v=40"></script>
