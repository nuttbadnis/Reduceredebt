<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="new_redebt10.aspx.vb" Inherits="new_redebt10" %>
				...
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="form-group required">
							...
							<div class="col-sm-10">
								<div class="form-inline">
									<input runat="server" id="hide_pick_refund" xd="hide_pick_refund" type="hidden" value="10">
