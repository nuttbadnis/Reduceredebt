				...
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="panel panel-info">
							...
							<div class="form-group form-500 refund4" style="display:none;">
								<label class="col-sm-2 control-label">ประเภทการคืนเงินเป็นโอน</label>
								<div class="col-sm-10">
									<select id="sel_pick_refund_type" class="form-control input-sm" style="display:none;">
										<option value="">กำลังโหลด..</option>
									</select>
									<label class="radio-inline"><input type="radio" name="rad_pick_refund" id="rad_pick_refund0">โอนเข้าบัญชีลูกค้าเอง</label>
									<label class="radio-inline"><input type="radio" name="rad_pick_refund" id="rad_pick_refund1">โอนเข้าบัญชีอื่น</label>
									<input runat="server" id="hide_pick_refund_type" xd="hide_pick_refund_type" type="hidden">
								</div>
							</div>
...
<script type="text/javascript" src="App_Inc/_js/redebt_operator.js?v=38889"></script>
<script type="text/javascript" src="App_Inc/_js/redebt_pick_refund.js?v=39"></script>
