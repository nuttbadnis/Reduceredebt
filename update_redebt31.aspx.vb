...
Partial Class update_redebt31
    Inherits System.Web.UI.Page
    Dim DB105 As New Cls_Data105
    Dim CP As New Cls_Panu
    Dim CF As New Cls_RequestFlow

    Dim pageUrl As String = "redebt31"
    ...
    Sub loadDetail(ByVal vRequest_id As String)
        ...
        If(vDT.Rows().Count() > 0)
            ...
            txt_dx01.Value() = vDT.Rows(0).Item("dx01") 'วันที่ออกใบเสร็จ
            ...
            txt_mx02.Value() = vDT.Rows(0).Item("mx02") 'ใบเสร็จออกจากช่องทาง
            ...
            inn_dx01.InnerHtml = vDT.Rows(0).Item("dx01") 'วันที่ออกใบเสร็จ
            ...
            inn_mx02.InnerHtml = vDT.Rows(0).Item("mx02") 'ใบเสร็จออกจากช่องทาง
    ...
    Sub Update_Submited()
        ...
        Dim dx01 As String = CP.rReplaceQuote(txt_dx01.Value) 'วันที่ออกใบเสร็จ
        ...
        Dim mx02 As String = CP.rReplaceQuote(txt_mx02.Value) 'ใบเสร็จออกจากช่องทาง
