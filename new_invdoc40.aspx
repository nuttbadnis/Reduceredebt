<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master_request.Master" CodeFile="new_invdoc40.aspx.vb" Inherits="new_invdoc40" %>
				...
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="panel panel-info">
							...
							<div class="form-group form-500 required">
								<label class="col-sm-2 control-label">ใบสรุปทรัพย์สินสูญหาย</label>
								<div class="col-sm-10">	
									<input name="request_file4" id="request_file4" type="file" class="form-control input-sm file-10mb">
								</div>
							</div>
							<div class="form-group form-500 required">
								<label class="col-sm-2 control-label">หนังสือยินยอมหักเงินเดือน</label>
								<div class="col-sm-10">
									<input name="request_file5" id="request_file5" type="file" class="form-control input-sm file-10mb">
								</div>
							</div>
							<div class="form-group form-500 required">
								<label class="col-sm-2 control-label">บันทึกค่าชดใช้ความเสียหาย</label>
								<div class="col-sm-10">	
									<input name="request_file6" id="request_file6" type="file" class="form-control input-sm file-10mb">
								</div>
							</div>
							<div class="form-group form-500 required">
								<label class="col-sm-2 control-label">แบบฟอร์มแจ้งทรัพย์สินสูญหาย</label>
								<div class="col-sm-10">
									<input name="request_file7" id="request_file7" type="file" class="form-control input-sm file-10mb">
								</div>
							</div>
							<div class="form-group form-500">
								<label class="col-sm-2 control-label">แบบฟอร์มแจ้งเปลี่ยนแปลงทรัพย์สิน (ถ้ามี)</label>
								<div class="col-sm-10">
									<input name="request_file8" id="request_file8" type="file" class="form-control input-sm file-10mb">
									<input name="request_file9" id="request_file9" type="file" style="display:none;" class="form-control input-sm file-10mb">
									<input name="request_file10" id="request_file10" type="file" style="display:none;" class="form-control input-sm file-10mb">
								</div>
							</div>
						</div>
						<div class="space-br"></div>
