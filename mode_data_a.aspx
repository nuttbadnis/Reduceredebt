<%@ Page Language="VB" AutoEventWireup="false" CodeFile="mode_data_a.aspx.vb" Inherits="mode_data_a" %>
...
<body>
	...
	<div class="container" style="margin-top: 20px;">
		...
		<ul class="nav nav-tabs" role="tablist" id="ul_tab">
			...
			<span class="float-right" id="load_time"></span>
		</ul>
	...
	,"<li id='10'><span class='glyphicon glyphicon-sort'></span><input type='checkbox' class='disorplay' id='chk_10' value='10' checked> Account</li>"
	,"<li id='11'><span class='glyphicon glyphicon-sort'></span><input type='checkbox' class='disorplay' id='chk_11' value='11' checked> ชื่อลูกค้า</li>"
	,"<li id='12'><span class='glyphicon glyphicon-sort'></span><input type='checkbox' class='disorplay' id='chk_12' value='12' checked> เลขที่ใบลดหนี้</li>"
	,"<li id='13'><span class='glyphicon glyphicon-sort'></span><input type='checkbox' class='disorplay' id='chk_13' value='13' checked> เลขที่ E-Pay</li>"
	,"<li id='14'><span class='glyphicon glyphicon-sort'></span><input type='checkbox' class='disorplay' id='chk_14' value='14' checked> วันที่สร้าง E-Pay</li>"
	,"<li id='15'><span class='glyphicon glyphicon-sort'></span><input type='checkbox' class='disorplay' id='chk_15' value='15' checked> วันที่อนุมัติ E-Pay</li>"
	,"<li id='16'><span class='glyphicon glyphicon-sort'></span><input type='checkbox' class='disorplay' id='chk_16' value='16' checked> Paid Date E-Pay</li>"
	,"<li id='17'><span class='glyphicon glyphicon-sort'></span><input type='checkbox' class='disorplay' id='chk_17' value='17' checked> Due Date E-Pay</li>"
