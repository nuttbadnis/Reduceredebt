...
<body>
	<form id="form1" runat="server" enctype="multipart/form-data">
		...
		<input runat="server" id="hide_subject_id" type="hidden">
		<input runat="server" id="hide_flow_id" type="hidden">
		<input runat="server" id="hide_prefix_id" type="hidden">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<li class="active"><a href="intro.aspx">สร้างคำขอใหม่</a></li>
		...
		<ol class="breadcrumb">
			<li class="active"><span class="glyphicon glyphicon-plus"></span> สร้างคำขอใหม่</li>
		</ol>
	...
	<div id="modal_notice" class="modal fade" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-nm">
			<div class="modal-content">
				...
				<div class="modal-body">
					<b class="txt-red">ปิดการ "สร้างคำขอใหม่" ชั่วคราว เพื่ออัพเดทฐานข้อมูล <br><br>จะสามารถกลับมาสร้างคำขอได้ ในเวลาประมาณ 10:30 น. (20/11/2019)</b>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-danger" data-dismiss="modal">ปิด</button>
				</div>
...
$(document).ready(function() {
	...
	var tabappend = "<li class='js-r'><a href='flow_pattern.aspx'><span class='glyphicon glyphicon-book'></span> Flow Pattern</a></li>";
	$('#nav_tab_project').append(tabappend)

	// $('#modal_notice').modal('show');

	// $('#modal_notice').on('hidden.bs.modal', function (e) {
