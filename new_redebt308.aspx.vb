...
Partial Class new_redebt308
    ...
    Dim pageUrl As String = "redebt308"
    ...
    Sub Submit_ShopStock(ByVal Source As Object, ByVal E As EventArgs)
        ...
        CF.InsertRequest8CN( _
            pageUrl, pageSubject_id, prefix_id _
            , flow_id, request_title_id, request_title _
            , request_remark, uemail_verify1, uemail_verify2, uemail_approve, uemail_takecn _
